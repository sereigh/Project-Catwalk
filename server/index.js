...
app.get("/reviewdata/:product_id", (req, res) => {
  helpers
    .getReviewData(req.params.product_id)
    .then((response) => {
...
app.get("/reviews/:product_id/:sort/:count", (req, res) => {
  helpers
    .getAllReviews(req.params.product_id, req.params.sort, req.params.count)
    .then((response) => {
      res.status(200).send(response.data);
    })
    .catch((error) => {
...
app.put("/reviews/:review_id/helpful", (req, res) => {
  helpers
    .voteHelpful(req.params.review_id)
    .then((response) => {
      res.status(200).send(response.data);
    })
    .catch((error) => {

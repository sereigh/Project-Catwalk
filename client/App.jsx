...
class App extends React.Component {
  ...
  retrieveReviewData(callback = () => {}) {
    ...
    axios
      ...
      .then((response) => {
        const totalReviews =
          (parseInt(response.data.recommended.false, 10) || 0) +
          (parseInt(response.data.recommended.true, 10) || 0);
        this.setState(
          {
    ...
    return (
      <div>
        ...
        <RelatedListContainer
          selectProductId={selectProductId}
          selectProductInfo={{
            name: selectProductInfo.name,
            features: selectProductInfo.features,
          }}
          selectAnotherProduct={this.selectAnotherProduct}
          addNewOutfit={this.addNewOutfit}
        ...
        <RatingsAndReviews
          ...
          productName={productList[0].name || "placeholder"}
          reviewData={reviewData}
          totalReviews={totalReviews}
          retrieveReviewData={this.retrieveReviewData}
        />
      </div>
    );
  }

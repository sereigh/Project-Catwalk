...
function ShowcaseThumbnails(props) {
  ...
  thumbnailArray = thumbnailArray.concat(
    selectStyleOptions[selectStyleIndex].photos.map(
      (styleThumbnailGallery, index) => (
        <div
  ...
  return (
    <div className="showcaseThumbnails">
      ...
      <span id="thumbnailGalleryHolder">{thumbnailArray}</span>
      <span id="downCarrotSpan">
        {/* v */}
        <img
          src="./img/iconfinder_angle-down.png"
          alt="downCarrot"
          id="downCarrot"
        />
      </span>

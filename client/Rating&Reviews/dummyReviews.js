const reviews = [
  {
    review_id: 287906,
    rating: 1,
    summary: "My product exploded!",
    recommend: false,
    response: null,
    body: "Instructions unclear, banana exploded",
  ...
  },
  {
    ...
    body:
      "Perferendis qui non sunt. Iste et ea vero. Tempora atque et ea in ea optio illum quia dolorem. Tenetur sed voluptatem sit rem quia est asperiores aldkfja;ldskfja;ldkfja;lsdkfja;dslkfja;lsdfkj;sf;ldk;ldkj;lsk;skjaslf;sla;df;sfj;dka;sfkjslfs;dfj;sfj;sdajskjad;kjs;kjadkajdfkldj.",
  ...
  },
  {
    ...
    rating: 1,
    summary:
      "Temporibus sed architecto fugit quisquam minus molestias dolorum quia itaque.",
    recommend: false,
    response: null,
    body:
